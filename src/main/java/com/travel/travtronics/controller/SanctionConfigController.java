...
@RestController
@RequestMapping("/sanctionconfig")
public class SanctionConfigController {
	...
	public APIResponse create(@RequestBody SanctionConfig model) {
		return sanctionConfigService.create(model);
	}
	
	@PutMapping(value = "update", consumes = "application/json", produces = "application/json")
	public APIResponse update(@RequestBody SanctionConfig model) {
		return sanctionConfigService.update(model);
	}
	
	@GetMapping(value = "id", produces = "application/json")
	public APIResponse getById(@RequestParam Long id) {
		return sanctionConfigService.getById(id);
	}
	
	@GetMapping(value = "orgId", produces = "application/json")
	public APIResponse getByOrgId(@RequestParam Long orgId) {
		return sanctionConfigService.getByOrgId(orgId);
	}
	...
	public APIResponsePaging getPagenationByOrganization(@RequestParam Long orgId, @RequestParam(required = false) String name,
		...
		return sanctionConfigService.getPaginationByOrganization(orgId, name, pageNo, pageSize, sortBy, sortType);
	}
}
